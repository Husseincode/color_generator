...
const Sidebar = () => {
  ...
  const convertCurrentColorToDifferentForms = () => {
    switch (heading) {
      case 'RGB':
        return [
          {
      ...
      case 'RGBA':
        return [
          {
            format: 'RGB',
            value: `rgb(${RGBAColors.red}, ${RGBAColors.green}, ${RGBAColors.blue})`,
          },
          {
            format: 'HEX',
            value: rgbToHex(RGBAColors.red, RGBAColors.green, RGBAColors.blue),
          },
          {
            format: 'RGBA',
            value: rgbToRgba(RGBAColors.red, RGBAColors.green, RGBAColors.blue),
          },
          {
            format: 'HSL',
            value: rgbToHsl(RGBAColors.red, RGBAColors.green, RGBAColors.blue),
          },
        ];
      default:
        break;
        ...
        {convertCurrentColorToDifferentForms()?.map((color, index) => (
          <li key={index} className='flex justify-between items-end'>
            ...
            <span
              ...
              title='copy'
              className='border border-gray-600 px-4 py-1 flex gap-2 items-center justify-center rounded-md cursor-pointer'>
              <svg
                width='24'
                height='24'
                viewBox='0 0 24 24'
